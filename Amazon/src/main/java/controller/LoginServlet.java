...
public class LoginServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("value of uservalidate in Login Servlet is :"+userValidate);
		 
		if((userValidate !=null) &&(userValidate!="Invalid user credentials")) //If function returns success string then user will be rooted to Home page
		 {
		 request.setAttribute("userName", userName); //with setAttribute() you can define a "key" and value pair so that you can get it in future using getAttribute("key")
		 request.setAttribute("customerid", userValidate);
